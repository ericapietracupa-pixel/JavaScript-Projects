...
// it then automatically progresses slideshow every 10 seconds
var slideIndex = 0;
showSlidesAuto();
...
//This function automatically changes the slide displayed every 10 seconds
function showSlidesAuto() {
    ...
    if (slideIndex > slides.length) { slideIndex = 1 } // If slideIndex is greater than the length of the array "slides", the slideIndex is set to 1
    slides[slideIndex - 1].style.display = "block"; // This displays the image in the slideshow
    dots[slideIndex - 1].className += " active"; // This adds the active styling to the dot associated with the image
